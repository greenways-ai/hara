...
- `specs/` — normative specifications:
  ...
  - `01-lang/001-language/draft/hal-langspec.edn` is the current portable HAL contract
  - `01-lang/001-language/draft/conformance/` contains machine-checked conformance corpora
  - `99-archive/planning/` contains non-normative source material grouped by domain
...
- Maven runs from the repo root via `-f java/pom.xml`; Surefire's working
  ...
  (`specs/01-lang/001-language/draft/conformance/...`, `lib/examples/...`,
  `website/docs/...`).
