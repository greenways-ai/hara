...
assertEqual(packageVersion(files["rust/Cargo.toml"]), expected, "rust/Cargo.toml package");
assertEqual(packageVersion(files["rust/raw/Cargo.toml"]), expected, "rust/raw/Cargo.toml package");
