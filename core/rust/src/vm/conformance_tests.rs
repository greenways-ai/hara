//! Corpus-driven conformance tests for `hara-specs/01-lang/010-bytecode/draft/hal-bytecode-vm.edn`.
//!
//! Every case in `hara-specs/01-lang/010-bytecode/draft/conformance/bytecode-vm.edn` is
...
fn bytecode_vm_conformance_corpus() {
    let manifest = kernel::parse_forms(include_str!(
        "../../../../../hara-specs/01-lang/010-bytecode/draft/conformance/bytecode-vm.edn"
    ))
