...
public class StdPortableLibraryProvidersTest {
  @Test
  public void canonicalPortableProvidersAreDiscoverable() {
    ...
    assertTrue(namespaces.contains("std.lib.zip"));
    assertTrue(namespaces.contains("std.lib.block"));
    assertTrue(namespaces.contains("std.lib.task"));
    assertTrue(namespaces.contains("code.test"));
  }
